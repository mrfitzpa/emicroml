...
class _MLDataSplitter():
    ...
    def _load_data_chunk(self,
        ...
        stop_candidate_2 = (chunk_idx+1) * max_num_ml_data_instances_per_chunk
        stop = min(stop_candidate_1, stop_candidate_2)
        single_dim_slice = slice(start, stop)
...
class _NoPoolResNetEntryFlow(torch.nn.Module):
    def __init__(self,
                 num_input_channels,
        ...
        self._conv_layer = self._generate_conv_layer()
        self._mini_batch_norm = self._generate_mini_batch_norm()
    ...
    def _generate_conv_layer(self):
        kwargs = {"in_channels": self._num_input_channels,
                  ...
                  "stride": 1,
                  "padding": (self._max_kernel_size-1)//2,
                  "padding_mode": "zeros",
                  "bias": False}
        conv_layer = torch.nn.Conv2d(**kwargs)

        self._initialize_conv_layer_weights(conv_layer)
    ...
    def _generate_mini_batch_norm(self):
        kwargs = {"num_features": self._conv_layer.out_channels,
                  "eps": self._mini_batch_norm_eps}
        mini_batch_norm = torch.nn.BatchNorm2d(**kwargs)
    ...
    def forward(self, input_tensor):
        intermediate_tensor = self._conv_layer(input_tensor)
...
class _NoPoolResNetMiddleFlow(torch.nn.Module):
    def __init__(self,
                 no_pool_resnet_entry_flow,
                 max_kernel_size,
        ...
        self._num_input_channels = \
            no_pool_resnet_entry_flow._num_output_channels
...
class _NoPoolResNetExitFlow(torch.nn.Module):
    def __init__(self,
                 no_pool_resnet_middle_flow,
        ...
        self._num_input_channels = \
            no_pool_resnet_middle_flow._num_output_channels
        self._fc_layers = \
            self._generate_fc_layers(no_pool_resnet_middle_flow)
    ...
    def _generate_fc_layers(self, no_pool_resnet_middle_flow):
        num_downsamplings = no_pool_resnet_middle_flow._num_downsamplings

        num_nodes_in_third_last_layer = (self._height_of_input_tensor_in_pixels
                                         * self._width_of_input_tensor_in_pixels
                                         * self._num_input_channels
                                         // 2**(2*num_downsamplings))
...
class _NoPoolResNet(torch.nn.Module):
    def __init__(self,
                 num_input_channels,
                 num_filters_in_first_conv_layer,
        ...
        self._num_filters_in_first_conv_layer = \
            num_filters_in_first_conv_layer
        self._max_kernel_size_in_entry_flow = \
            max_kernel_size_in_entry_flow
        self._max_kernel_size_in_middle_flow = \
            max_kernel_size_in_middle_flow
        self._building_block_counts_in_stages = \
            building_block_counts_in_stages
        self._height_of_input_tensor_in_pixels = \
    ...
    def _generate_entry_flow(self):
        kwargs = {"num_input_channels": \
                  ...
                  "mini_batch_norm_eps": \
                  self._mini_batch_norm_eps}
        entry_flow = _NoPoolResNetEntryFlow(**kwargs)
    ...
    def _generate_middle_flow(self):
        kwargs = {"no_pool_resnet_entry_flow": \
                  self._entry_flow,
                  "max_kernel_size": \
                  self._max_kernel_size_in_middle_flow,
                  "building_block_counts_in_stages": \
                  ...
                  "mini_batch_norm_eps": \
                  self._mini_batch_norm_eps}
        middle_flow = _NoPoolResNetMiddleFlow(**kwargs)
    ...
    def _generate_exit_flow(self):
        kwargs = {"no_pool_resnet_middle_flow": \
                  self._middle_flow,
                  "height_of_input_tensor_in_pixels": \
                  self._height_of_input_tensor_in_pixels,
                  "width_of_input_tensor_in_pixels": \
                  ...
                  "mini_batch_norm_eps": \
                  self._mini_batch_norm_eps}
        exit_flow = _NoPoolResNetExitFlow(**kwargs)
